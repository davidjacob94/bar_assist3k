...
unsigned long IPAdd[1] = {0X0a01A8C0};//use this to set it to static//192.168.1.10
unsigned long SubNetMask[1] = {0x00FFFFFF};
unsigned long dfGW[1] = {0xff01A8c0};
unsigned long DNSServer[1] = {0xff01A8c0};
