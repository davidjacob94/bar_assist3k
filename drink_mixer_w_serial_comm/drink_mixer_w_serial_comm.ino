...
void loop() {
  ...
  if ((buttonState1 == LOW && buttonState3==HIGH && buttonState4==HIGH) || val == 1){
    ...
    else  if ((buttonState1 == HIGH && buttonState3==LOW && buttonState4==HIGH) || val == 3){
    ...
    //Trashcan
    //BUTTON 4, MOTOR 4
    else  if ((buttonState1 == HIGH && buttonState3==HIGH && buttonState4==LOW) || val == 2){
